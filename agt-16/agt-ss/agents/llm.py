...
agt16.agents.llm
-----------------
Thin Anthropic client wrapper shared by all AGT-16 sub-agents.

Identical interface to agt_ss.agents.llm.
...
def reason(system: str, user: str, max_tokens: int = 1500) -> str:
    """
    ...
    executive summaries, and board presentation prose.
    """
